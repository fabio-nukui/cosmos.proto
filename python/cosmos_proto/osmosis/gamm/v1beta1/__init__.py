...
# sources: osmosis/gamm/v1beta1/balancerPool.proto, osmosis/gamm/v1beta1/query.proto, osmosis/gamm/v1beta1/tx.proto
...
@dataclass(eq=False, repr=False)
class BalancerPoolParams(betterproto.Message):
    """
...
@dataclass(eq=False, repr=False)
class BalancerPool(betterproto.Message):
    address: str = betterproto.string_field(1)
    id: int = betterproto.uint64_field(2)
    pool_params: "BalancerPoolParams" = betterproto.message_field(3)
...
class MsgCreateBalancerPool(betterproto.Message):
    ...
    pool_params: "BalancerPoolParams" = betterproto.message_field(2)
...
class QueryPoolParamsResponse(betterproto.Message):
    balancer_pool_params: "BalancerPoolParams" = betterproto.message_field(
        1, group="params"
    )
...
class MsgStub(betterproto.ServiceStub):
    async def create_balancer_pool(
        ...
        *,
        sender: str = "",
        pool_params: "BalancerPoolParams" = None,
        ...
        return await self._unary_unary(
            "/osmosis.gamm.v1beta1.Msg/CreateBalancerPool",
            request,
            MsgCreateBalancerPoolResponse,
        )
...
class MsgBase(ServiceBase):
    async def create_balancer_pool(
        self,
        sender: str,
        pool_params: "BalancerPoolParams",
    ...
    def __mapping__(self) -> Dict[str, grpclib.const.Handler]:
        return {
            "/osmosis.gamm.v1beta1.Msg/CreateBalancerPool": grpclib.const.Handler(
